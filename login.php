...
<!-- Mirrored from theme.codeastrology.com/listghor/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 May 2020 09:19:01 GMT -->
<head>
		<!-- all meta -->
		<meta charset="UTF-8">
				...
				<div class="listghor_wrapper_form">
					...
					<div class="wrapper_form_right">
						...
						<div class="listghor_form">
							<form action="https://theme.codeastrology.com/listghor/registration.html" method="post" class="login_form">
								...
								<div class="form_button">
									<button class="listghor_btn form_btn">sign in</button>
								</div>
								<div class="form_text">
...
<!-- Mirrored from theme.codeastrology.com/listghor/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 May 2020 09:19:02 GMT -->
</html>