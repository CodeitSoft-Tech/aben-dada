...
<!-- Mirrored from theme.codeastrology.com/listghor/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 May 2020 09:18:58 GMT -->
<head>
		<!-- all meta -->
		<meta charset="UTF-8">
	...
	<body>
		...
		<section class="listghor_faq listghor_faq_1 gray_bg section_padding wow fadeInUp">
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-lg-8">
                            ...
                            <div id="accordion">
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading5">
                                        <a href="#" data-toggle="collapse" data-target="#collapse5" aria-expanded="false" aria-controls="collapse5">Why do we use it?
                                            <i class="fas fa-minus"></i>
                                            <i class="fas fa-plus"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading6">
                                        <a href="#" data-toggle="collapse" data-target="#collapse6" aria-expanded="false" aria-controls="collapse6">Why do we use it?
                                            <i class="fas fa-minus"></i>
                                            <i class="fas fa-plus"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading7">
                                        <a href="#" data-toggle="collapse" data-target="#collapse7" aria-expanded="false" aria-controls="collapse7">Why do we use it?
                                            <i class="fas fa-minus"></i>
                                            <i class="fas fa-plus"></i>
                                        </a>
                                    </div>
